...
local Window = Library:CreateWindow('Anime Hub / Premium')
...
Changelog:addChangelog('Menu : Anime Hub' )
Changelog:addChangelog('Thông Tin Liên Hệ')
Changelog:addChangelog('Zalo: 0564348042')
Changelog:addChangelog('Tik Tok: @hthinh_209')
Changelog:addChangelog('FB : Hưng Thịnh')
